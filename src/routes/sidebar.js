...
const routes = [
  ...
  },
  {
    ...
    name: 'Data Petugas', // name that appear in Sidebar
  },
  {
    path: '/app/transactions', // url
    icon: <ArchiveBoxIcon className={iconClasses}/>, // icon component
    name: 'Data Barang', // name that appear in Sidebar
  },

  // {
  //   icon: <PencilSquareIcon className={submenuIconClasses}/>, // icon component
  //   path: '/app/settings-team', // url
  //   name: 'Edit Barang', // name that appear in Sidebar
  // },

  {
    path: '/app/settings-billing', // url
    icon: <PrinterIcon className={iconClasses}/>, // icon component
